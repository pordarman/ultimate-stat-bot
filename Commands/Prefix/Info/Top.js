...
module.exports = {
    ...
    description: "Sunucudaki en çok mesaj atılan kişileri, kanalları, sesli sohbet sürelerini ve kanallarını gösterir", // Komutun açıklaması
    ...
    async execute(msg, args) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                statMessages.descriptions.all(Util.toHumanize(totalMessagesCount), Util.duration(totalVoiceTimes))
            )
            .addFields(
                {
